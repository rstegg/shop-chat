...
const EditPostForm = ({handleSubmit, shopTypeValue, topicTypeValue}) =>
  <Form onSubmit={handleSubmit}>
    ...
    <Field component={SelectField} name='shop_type' label='Type' placeholder='Type' options={options} />
    {shopTypeValue === 'topic' && <Field component={SelectField} name='topic' label='Type of topic' placeholder='Type of topic' options={topic_options} />}
...
({
  shopTypeValue: selector(state, 'shop_type'),

...
const ProductMenuForm = ({handleSubmit, products}) =>
  <Form onSubmit={handleSubmit}>
    {!!products.length && <Field component={SelectField} name='product' label='Product' placeholder='Product' options={createOptions(products)} />}
    {!products.length && <Field component={InputField} name='product' label='Product' placeholder='Product' />}
